...
const TopHeader = () => {
  return (
    <div className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-[#5C7CC2] to-[#C3628C] text-white font-medium py-2">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-center md:justify-between items-center text-sm gap-2 md:gap-0">
          <a href="#" className="flex items-center gap-2">
            ...
            <span className="ml-2">Rated 4.7 on G2</span>
          </a>
          <div className="flex items-center gap-6">
            <a href="/partners" className="hover:underline">Become a Partner</a>
            <a href="/sales" className="hover:underline">Contact Sales</a>
          </div>
        </div>
      </div>
    </div>
